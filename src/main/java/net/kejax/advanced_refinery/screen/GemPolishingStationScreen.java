package net.kejax.advanced_refinery.screen;
...
public class GemPolishingStationScreen extends AbstractContainerScreen<GemPolishingStationMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(AdvancedRefinery.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
